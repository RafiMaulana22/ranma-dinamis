                    ...
                    <div class="d-flex align-items-center gap-4 me-6 me-sm-0">
                        <div class="avatar avatar-lg">
                            <div class="avatar-initial bg-label-primary rounded">
                                <div>
                                    <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/icons/laptop.svg"
                    ...
                    <div class="d-flex align-items-center gap-4">
                        <div class="avatar avatar-lg">
                            <div class="avatar-initial bg-label-info rounded">
                                <div>
                                    <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/icons/lightbulb.svg"
                    ...
                    <div class="d-flex align-items-center gap-4">
                        <div class="avatar avatar-lg">
                            <div class="avatar-initial bg-label-warning rounded">
                                <div>
                                    <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/icons/check.svg"
                                        alt="Check" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="content-right">
        ...
        <div class="col-xxl-4 col-md-6">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-2 me-n1" type="button"
                            id="assignmentProgress" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <i class="ti ti-dots-vertical ti-md text-muted"></i>
                        </button>
